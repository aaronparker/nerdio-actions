# Variables
[System.String] $FilePath = "${Env:ProgramFiles}\Google\Chrome\Application\chrome.exe"
[System.String] $PrefsPath = "${Env:ProgramFiles}\Google\Chrome\Application\initial_preferences"
